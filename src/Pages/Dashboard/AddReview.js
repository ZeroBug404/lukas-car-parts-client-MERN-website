...
const AddReview = () => {
   ...
   return (
    <div class="card w-1/2 bg-base-100 shadow-xl">
      <div class="p-6">
        <h2 class="card-title text-slate-600 mb-2">
        ...
        <form >
            ...
            <select ref={starRef} class="select select-warning w-2/5 max-w-xs text-slate-600">
            <option>⭐</option>
            <option>⭐⭐</option>
            <option>⭐⭐⭐</option>
            <option>⭐⭐⭐⭐</option>
            ...
            <button onClick={handleAddReview} class="btn btn-primary w-40">Add</button>
            </div>
        </form>
      </div>
    </div>
